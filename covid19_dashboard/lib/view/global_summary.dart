...
class GlobalSummaryView extends StatelessWidget {
          ...
          body: Container(
            ...
            child: Obx(
              () => Column(
                ...
                children: [
                  summaryController.gettingGlobalSummary.value
                      ? LoadingWidget()
                      : Expanded(
                          flex: 2,
                          child: Container(
                      ...
                      children: [
                        ...
                        Expanded(flex: 8,
                          child: Container(
                              ...
                              width: maxWidth,
                              child: summaryController.gettingGlobalSummary.value
                                  ? LoadingWidget()
                                  : BarChart(
                                      BarChartData(
                                          barGroups: summaryController
                                              .totalNewConfirmedBarGroups,
                                          gridData: FlGridData(
